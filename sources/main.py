...
@eel.expose
def home11():
    gv.update('gesturePredictMode','TRUE','global')
    viewGesture()
    try:
        import camera_access
        #import gesture_verify
...
@eel.expose
def home022():
    gv.update('gesturePredictMode','FALSE','global')
    try:
        import camera_access
        #import gesture_verify
    except Exception as exp:
...
def newGestureName(a):
    ...
    global infoDict,bufferData,newModelName
    bufferData = infoDict
    newModelName = a
    bufferData[a] = 'None'
...
def finalizeModel():
    ...
    gdata.loc[nindex-1,'Gestures'] = newModelName
    ...
    print("Main.py : ** RESTART APP ** to use new Model and new Gestures\n")
    return True
